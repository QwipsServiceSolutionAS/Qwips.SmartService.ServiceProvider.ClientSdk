...
using Qwips.SmartService.ServiceProvider.ClientSdk.Api2.Serviceprovider.Customer.Person.Item.Add;
using Qwips.SmartService.ServiceProvider.ClientSdk.Api2.Serviceprovider.Customer.Person.Item.Update;
...
using System;
namespace Qwips.SmartService.ServiceProvider.ClientSdk.Api2.Serviceprovider.Customer.Person.Item {
    /// <summary>
    /// Builds and executes requests for operations under \api2\ServiceProvider\Customer\person\{customerId}
    /// </summary>
    public class WithCustomerItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithCustomerItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api2/ServiceProvider/Customer/person/{customerId}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithCustomerItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithCustomerItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api2/ServiceProvider/Customer/person/{customerId}", rawUrl) {
        }
