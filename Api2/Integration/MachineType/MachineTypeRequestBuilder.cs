...
using Qwips.SmartService.Integration.ClientSdk.Api2.Integration.MachineType.Item;
...
using System;
namespace Qwips.SmartService.Integration.ClientSdk.Api2.Integration.MachineType {
    /// <summary>
    ...
    public class MachineTypeRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Qwips.SmartService.Integration.ClientSdk.api2.Integration.MachineType.item collection</summary>
...
#nullable enable
        public async Task<List<SimpleMachineTypeDto>?> GetAsync(Action<MachineTypeRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<SimpleMachineTypeDto>> GetAsync(Action<MachineTypeRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            var requestInfo = ToGetRequestInformation(requestConfiguration);
            var collectionResult = await RequestAdapter.SendCollectionAsync<SimpleMachineTypeDto>(requestInfo, SimpleMachineTypeDto.CreateFromDiscriminatorValue, default, cancellationToken);
