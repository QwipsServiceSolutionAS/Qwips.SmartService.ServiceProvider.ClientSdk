...
namespace Qwips.SmartService.ServiceProvider.ClientSdk.Models {
    public class MachineListFilterDto : IParsable {
...
#nullable restore
        ...
        public static MachineListFilterDto CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new MachineListFilterDto();
        }
        /// <summary>
