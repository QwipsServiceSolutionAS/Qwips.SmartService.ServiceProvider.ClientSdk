...
#nullable restore
        ...
        public static MethodInfo CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"ReturnParameter", n => { ReturnParameter = n.GetObjectValue<ParameterInfo>(ParameterInfo.CreateFromDiscriminatorValue); } },
                {"ReturnType", n => { ReturnType = n.GetObjectValue<TypeObject>(TypeObject.CreateFromDiscriminatorValue); } },
                {"ReturnTypeCustomAttributes", n => { ReturnTypeCustomAttributes = n.GetObjectValue<ICustomAttributeProvider>(ICustomAttributeProvider.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ParameterInfo>("ReturnParameter", ReturnParameter);
            writer.WriteObjectValue<TypeObject>("ReturnType", ReturnType);
            writer.WriteObjectValue<ICustomAttributeProvider>("ReturnTypeCustomAttributes", ReturnTypeCustomAttributes);
        }
    }
}
