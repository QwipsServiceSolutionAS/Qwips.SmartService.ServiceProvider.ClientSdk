...
namespace Qwips.SmartService.ServiceProvider.ClientSdk.Models {
    public class ArticleModel : IParsable {
...
#nullable restore
        ...
        public static ArticleModel CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"StoreItems", n => { StoreItems = n.GetCollectionOfObjectValues<StoreItemModel>(StoreItemModel.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<StoreItemModel>("StoreItems", StoreItems);
