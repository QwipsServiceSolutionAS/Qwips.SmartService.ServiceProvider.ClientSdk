...
namespace Qwips.SmartService.ServiceProvider.ClientSdk.Models {
    public class SupplierListFilterDto : IParsable {
...
#nullable restore
        ...
        public static SupplierListFilterDto CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new SupplierListFilterDto();
        }
        /// <summary>
