...
namespace Qwips.SmartService.ServiceProvider.ClientSdk.Models {
    public class SupplierFailiureCodeModel : IParsable {
...
#nullable restore
        ...
        public static SupplierFailiureCodeModel CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new SupplierFailiureCodeModel();
        }
        /// <summary>
