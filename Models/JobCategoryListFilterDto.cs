...
namespace Qwips.SmartService.ServiceProvider.ClientSdk.Models {
    public class JobCategoryListFilterDto : IParsable {
...
#nullable restore
        ...
        public static JobCategoryListFilterDto CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new JobCategoryListFilterDto();
        }
        /// <summary>
