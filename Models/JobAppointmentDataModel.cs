...
namespace Qwips.SmartService.ServiceProvider.ClientSdk.Models {
    public class JobAppointmentDataModel : IParsable {
...
#nullable restore
        ...
        public static JobAppointmentDataModel CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new JobAppointmentDataModel();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"Participants", n => { Participants = n.GetCollectionOfObjectValues<ParticipantDataModel>(ParticipantDataModel.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<ParticipantDataModel>("Participants", Participants);
