...
namespace Qwips.SmartService.ServiceProvider.ClientSdk.Models {
    public class ServiceAgreementListFilterDto : IParsable {
...
#nullable restore
        ...
        public static ServiceAgreementListFilterDto CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ServiceAgreementListFilterDto();
        }
        /// <summary>
