...
namespace Qwips.SmartService.Integration.ClientSdk.Models {
    public class MachineAddedFieldsDto : IParsable {
        ...
        public static MachineAddedFieldsDto CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new MachineAddedFieldsDto();
        }
        /// <summary>
