...
namespace Qwips.SmartService.ServiceProvider.ClientSdk.Models {
    public class ArticleListFilterDto : IParsable {
...
#nullable restore
        ...
        public static ArticleListFilterDto CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ArticleListFilterDto();
        }
        /// <summary>
