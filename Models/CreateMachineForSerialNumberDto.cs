...
namespace Qwips.SmartService.ServiceProvider.ClientSdk.Models {
    public class CreateMachineForSerialNumberDto : IParsable {
...
#nullable restore
        ...
        public static CreateMachineForSerialNumberDto CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new CreateMachineForSerialNumberDto();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"MachineModelId", n => { MachineModelId = n.GetStringValue(); } },
                {"Name", n => { Name = n.GetStringValue(); } },
                {"Note", n => { Note = n.GetStringValue(); } },
                {"RetiredDate", n => { RetiredDate = n.GetDateTimeOffsetValue(); } },
                {"SerialNumber", n => { SerialNumber = n.GetStringValue(); } },
                {"ServiceAgreement", n => { ServiceAgreement = n.GetStringValue(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteStringValue("MachineModelId", MachineModelId);
            writer.WriteStringValue("Name", Name);
            writer.WriteStringValue("Note", Note);
            writer.WriteDateTimeOffsetValue("RetiredDate", RetiredDate);
            writer.WriteStringValue("SerialNumber", SerialNumber);
            writer.WriteStringValue("ServiceAgreement", ServiceAgreement);
