...
namespace Qwips.SmartService.ServiceProvider.ClientSdk.Models {
    public class SupplierFailureCodeListFilterDto : IParsable {
...
#nullable restore
        ...
        public static SupplierFailureCodeListFilterDto CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new SupplierFailureCodeListFilterDto();
        }
        /// <summary>
